...
\midrule
Grabaciones propias de personas sanas. & Cámara fija, iluminación ambiente, tablero de calibración al inicio. \\
...
\captionof{figure}{Ejemplo ilustrativo de los puntos de referencia entregados por el modelo \texttt{HandLandmarker} de \texttt{MediaPipe} sobre la imagen de una mano.}
...
En la tabla \ref{tab:modelos-cap2} se listan los modelos preentrenados utilizados, indicando su origen, la tarea sobre la que operan y las características relevantes para el sistema.
...
\midrule
HandLandmarker (MediaPipe 0.10). & Detección de 21 puntos por mano. & Imágenes anotadas de manos en distintas poses, entornos y condiciones de iluminación \citep{zhang2020mediapipehands}. & Ejercicios de finger tapping y temblor de mano. \\
