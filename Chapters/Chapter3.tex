...
\caption{Fase estática de la distancia pulgar-índice en una sesión de finger tapping.}
...
La figura \ref{fig:ui-upload-results} presenta una composición con dos capturas de pantalla: la vista de carga con progreso en tiempo real y la vista de resultados con gráficos de métricas, sin datos identificables del paciente.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{Figures/cap_3/ui_1_pantalla_para_subir_videos.png}

\vspace{0.5cm}

\includegraphics[width=0.85\textwidth]{Figures/cap_3/ui_2_resultados_sesion_2.png}
\caption{Interfaz de carga de sesión y de visualización de resultados.}
