...
\begin{center}
	...
	\captionof{figure}{Secuencia de la prueba nariz-dedo, desde la postura de brazos extendidos y contactos alternos con la nariz.}
...
\texttt{MediaPipe Pose}. & Video; modelos preentrenados integrados al marco. & Landmarks normalizados 2D/3D y continuidad temporal en un grafo de procesamiento integrado \citep{lugaresi2019mediapipe}. & Idoneidad para tiempo casi real y bajo consumo en dispositivos habituales, frente a estimadores más pesados \citep{lugaresi2019mediapipe}. \\
\bottomrule
\end{tabular}}
\end{minipage}
\end{center}
