...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Sistema de análisis digital de oscilaciones gestuales en pacientes con Parkinson mediante inteligencia artificial} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Esp. Ing. Alex Damián Barria Cárdenas} \\[1cm]
        ...
        \textbf{Maestría en Inteligencia Artificial} \\[2cm]
        }

        % Director
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Director:} PhD. Ing. Fernando Bernuy (Universidad Nacional de Chile)} \\[1cm]
    ...
    \begin{flushright}
        ...
        Ciudad de Buenos Aires, agosto de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
